...
import { getStoredPrograms, savePrograms, isOnboardingCompleted } from "@/lib/storage";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (storedProfileId) {
      ...
      // Only redirect to onboarding if it was never completed
      // This prevents re-showing onboarding on network errors
